...
RSpec.describe Nais::Log::Parser do
  ...
  it "does remap journald fields" do
    ...
    expect(Nais::Log::Parser.remap_journald_fields(r)).
      to eql({'severity'=>'6','facility'=>'daemon','level'=>'Info', 'uid'=>'0', 'gid'=>'0', 'category'=>'stdout','host'=>'e34apvl00685.devillo.no','program'=>'update_engine','pid'=>'703','command'=>'update_engine','message'=>'I0117 14:30:46.485997   703 action_processor.cc:73] ActionProcessor::ActionComplete: finished last action of type OmahaRequestAction','@timestamp'=>'2019-01-22T11:05:11.168093Z'})
  end
